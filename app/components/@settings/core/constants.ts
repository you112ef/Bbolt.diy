...
export const TAB_ICONS: Record<TabType, string> = {
  ...
  'ai-models': 'i-ph:brain',
  'ai-custom': 'i-ph:magic-wand',
...
export const TAB_DESCRIPTIONS: Record<TabType, string> = {
  ...
  'ai-models': 'Upload and manage offline AI models for local inference',
  'ai-custom': 'Customize AI model and system prompt',
...
export const DEFAULT_TAB_CONFIG = [
  ...
  { id: 'ai-models', visible: false, window: 'user' as const, order: 4 },
  { id: 'ai-custom', visible: true, window: 'user' as const, order: 4 },
