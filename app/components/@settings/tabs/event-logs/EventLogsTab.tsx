...
export function EventLogsTab() {
  ...
  const exportAsPDF = () => {
    try {
      ...
      // Add subtitle with YOUSEF.SHTIWE
      doc.setFontSize(12);
      doc.setFont('helvetica', 'normal');
      doc.text('YOUSEF.SHTIWE - AI Development Platform', margin, 45);
      yPos = 70;
      ...
      for (let i = 1; i <= totalPages; i++) {
        ...
        // Add footer text
        doc.text('Generated by YOUSEF.SHTIWE', margin, doc.internal.pageSize.getHeight() - 10);
