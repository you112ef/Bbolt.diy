...
import { aiExtensionStore } from '~/lib/stores/aiExtensions';

// Import enhanced editor panel
import EnhancedEditorPanel from '~/components/editor/EnhancedEditorPanel';
// Import original editor panel as fallback
...
// Enhanced File Modified Dropdown with AI features
const EnhancedFileModifiedDropdown = memo(
  ({
    fileHistory,
    onSelectFile,
  }: {
...
export const EnhancedWorkbench = memo(
  ({ chatStarted, isStreaming, metadata, updateChatMestaData, setSelectedElement }: EnhancedWorkspaceProps) => {
    ...
    const aiSettings = useStore(aiExtensionStore);
    ...
    // Choose which editor panel to render based on settings
    const renderEditorPanel = () => {
      ...
      // Use enhanced editor panel with Monaco toggle
      return <EnhancedEditorPanel {...commonProps} />;
    };
            ...
            <div className="absolute inset-0 px-2 lg:px-4">
              <div className="h-full flex flex-col bg-bolt-elements-background-depth-2 border border-bolt-elements-borderColor shadow-sm rounded-lg overflow-hidden">
                <div className="flex items-center px-3 py-2 border-b border-bolt-elements-borderColor gap-1.5">
                  ...
                  {/* Enhanced Workbench indicator */}
                  <div className="flex items-center gap-1 px-2 py-1 text-xs rounded bg-blue-500/10 text-blue-400 border border-blue-500/20">
                  ...
                  {selectedView === 'diff' && (
                    <EnhancedFileModifiedDropdown fileHistory={fileHistory} onSelectFile={handleSelectFile} />
                  )}
                  <IconButton
                    icon="i-ph:x-circle"
                    className="-mr-1"
