...
export default function PlanetScaleConnection() {
  ...
  const handleDisconnect = () => {
    ...
    setToken('');
    toast.success('Disconnected from PlanetScale');
  };
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <img
              ...
              src={`https://cdn.simpleicons.org/planetscale/black`}
            />
            <h3 className="text-base font-medium text-bolt-elements-textPrimary">PlanetScale Connection</h3>
          </div>
        </div>
        ...
        {!isConnected ? (
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2 text-green-600 dark:text-green-400">
              ...
              <span className="text-sm font-medium">Connected to PlanetScale</span>
            </div>
            <button
