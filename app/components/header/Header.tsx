    ...
    >
      <div className="flex items-center gap-3 z-logo text-bolt-elements-textPrimary cursor-pointer">
        ...
        <a href="/" className="text-2xl font-semibold text-accent flex items-center">
          <img src="/logo-light-styled.png" alt="logo" className="h-9 w-auto inline-block dark:hidden" />
          <img src="/logo-dark-styled.png" alt="logo" className="h-9 w-auto inline-block hidden dark:block" />
        </a>
      </div>
      {chat.started && (
        <>
