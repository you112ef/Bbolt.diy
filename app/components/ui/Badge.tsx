...
const badgeVariants = cva(
  'inline-flex items-center gap-1 transition-colors focus:outline-none focus:ring-2 focus:ring-bolt-elements-ring focus:ring-offset-2',
  {
    variants: {
      ...
      size: {
        default: 'rounded-full px-1.5 sm:px-2 lg:px-2.5 py-0.5 text-[10px] sm:text-xs font-semibold',
        sm: 'rounded-full px-1 sm:px-1.5 py-0.5 text-[9px] sm:text-xs',
        md: 'rounded-md px-1.5 sm:px-2 py-0.5 sm:py-1 text-[10px] sm:text-xs font-medium',
        lg: 'rounded-md px-2 sm:px-2.5 py-1 sm:py-1.5 text-xs sm:text-sm',
      },
    },
    defaultVariants: {
      variant: 'default',
